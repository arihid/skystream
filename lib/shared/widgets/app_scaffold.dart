...
// Import our new overlay!
import 'package:skystream/shared/widgets/gamepad_hints_overlay.dart';

// 🎯 Since we killed the persistent sidebar, we don't need FocusNodes anymore.
// This is now a simple, lightning-fast ConsumerWidget!
        ...
        if (profile.isTv || context.isTabletOrLarger) {
          ...
          return PopScope(
            ...
            child: Material(
              ...
              child: SafeArea(
                bottom: false,
                // We wrap the shell in a Column so the Steam-style bottom bar reserves its own space!
                child: Column(
